...
********************************************************************************/
	...
	*Regression military presence, no controls
		reg 			`var' ln_dist_mil_fac `weights', `se_area'
